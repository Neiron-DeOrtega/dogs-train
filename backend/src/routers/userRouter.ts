...
userRouter.delete('/delete/:uid', tokenVerify, adminVerify, userController.delete) // Удаление пользователя
...
userRouter.post('/average', userController.getAverageRatingsByDate)

userRouter.post('/', tokenVerify, adminVerify, userController.getUserByPhone) // Найти пользователя по ID
